                    ...
                    <div class="modal-body">
                        <form>
                            ...
                            <div class="mb-3 w-75">
                                ...
                                <select class="form-select form-select-sm" id="brand-drop" aria-label="computer manufacturer label" required
                            ...
                            <div class="mb-3 w-75">
                                ...
                                <select class="form-select form-select-sm" id="model-drop" aria-label="computer model label" required>
                                    <!-- <option selected>- select computer model -</option> -->
                                    <?php foreach($result as $res) :?>
                                        <option 
                            ...
                            <!-- Input : Hostname -->
                            <div class="mb-3 w-50">
                                <label for="hostname" class="col-form-label">PC Hostname</label>
                                <input type="text" class="form-control" id="hostname">
                            </div>
                            
                            =======================================================================

                            <!-- Input : User Account (SESA) -->
                            <div class="mb-3 w-50">
                                <label for="useraccount" class="col-form-label">User Account</label>
